...
type LoginRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`
	AppId    int32  `protobuf:"zigzag32,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"`
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x11, 0x52, 0x05, 0x61, 0x70, 0x70, 0x49, 0x64,
	...
	0x6e, 0x67, 0x63, 0x34, 0x37, 0x33, 0x36, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73,
